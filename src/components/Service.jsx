      ...
      <div className="Service">
        <div className="box">
          <div className="text">
            ...
            <div className='box_buttons'>
              <Link className="box_buttons_link" to={user ? '/generate-image' : "/login"}><Button className="tryNow">Try Now <KeyboardArrowRightIcon /></Button></Link>
        ...
        <div className="box">
          <div className="text">
            ...
            <div className='box_buttons'>
              <Link className="box_buttons_link" to={user ? '/image-tagger' : "/login"}><Button className="tryNow">Try Now <KeyboardArrowRightIcon /></Button></Link>
        ...
        <div className="box">
          <div className="text">
            ...
            <div className='box_buttons'>
              <Link className="box_buttons_link" to={user ? '/news-generation' : "/login"}><Button className="tryNow">Try Now <KeyboardArrowRightIcon /></Button></Link>
